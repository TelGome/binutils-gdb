...
/*Xqcia*/
#define MATCH_QC_ADDSAT 0x1c00300b
#define MASK_QC_ADDSAT 0xfe00707f
#define MATCH_QC_ADDUSAT 0x1e00300b
#define MASK_QC_ADDUSAT 0xfe00707f
#define MATCH_QC_NORM 0x0e00300b
#define MASK_QC_NORM 0xfff0707f
#define MATCH_QC_NORMEU 0x1200300b
#define MASK_QC_NORMEU 0xfff0707f
#define MATCH_QC_NORMU 0x1000300b
#define MASK_QC_NORMU 0xfff0707f
#define MATCH_QC_SHLSAT 0x1400300b
#define MASK_QC_SHLSAT 0xfe00707f
#define MATCH_QC_SHLUSAT 0x1800300b
#define MASK_QC_SHLUSAT 0xfe00707f
#define MATCH_QC_SUBSAT 0x2000300b
#define MASK_QC_SUBSAT 0xfe00707f
#define MATCH_QC_SUBUSAT 0x2200300b
#define MASK_QC_SUBUSAT 0xfe00707f
#define MATCH_QC_WRAP 0x2400300b
#define MASK_QC_WRAP 0xfe00707f
#define MATCH_QC_WRAPI 0x0000000b
#define MASK_QC_WRAPI 0x8000707f
/* xqciac*/
#define MATCH_QC_C_MULIADD 0x2002
#define MASK_QC_C_MULIADD 0xe003
#define MATCH_QC_C_MVEQZ 0xac02
#define MASK_QC_C_MVEQZ 0xfc63
#define MATCH_QC_MULIADD 0x0000600b
#define MASK_QC_MULIADD 0x0000707f
#define MATCH_QC_SHLADD 0x4000300b
#define MASK_QC_SHLADD 0xc000707f
/* Xqcibi */
#define MATCH_QC_BEQI 0x0000007b
#define MASK_QC_BEQI 0x0000707f
#define MATCH_QC_BGEI 0x0000507b
#define MASK_QC_BGEI 0x0000707f
#define MATCH_QC_BGEUI 0x0000707b
#define MASK_QC_BGEUI 0x0000707f
#define MATCH_QC_BLTI 0x0000407b
#define MASK_QC_BLTI 0x0000707f
#define MATCH_QC_BLTUI 0x0000607b
#define MASK_QC_BLTUI 0x0000707f
#define MATCH_QC_BNEI 0x0000107b
#define MASK_QC_BNEI 0x0000707f
#define MATCH_QC_E_BEQI 0x00000180401f
#define MASK_QC_E_BEQI 0x000001f0707f
#define MATCH_QC_E_BGEI 0x000001d0401f
#define MASK_QC_E_BGEI 0x000001f0707f
#define MATCH_QC_E_BGEUI 0x000001f0401f
#define MASK_QC_E_BGEUI 0x000001f0707f
#define MATCH_QC_E_BLTI 0x000001c0401f
#define MASK_QC_E_BLTI 0x000001f0707f
#define MATCH_QC_E_BLTUI 0x000001e0401f
#define MASK_QC_E_BLTUI 0x000001f0707f
#define MATCH_QC_E_BNEI 0x00000190401f
#define MASK_QC_E_BNEI 0x000001f0707f
/* xqcibm */
#define MATCH_QC_BREV32 0x0c00300b
#define MASK_QC_BREV32 0xfff0707f
#define MATCH_QC_C_BEXTI 0x9001
#define MASK_QC_C_BEXTI 0xfc03
#define MATCH_QC_C_BSETI 0x9401
#define MASK_QC_C_BSETI 0xfc03
#define MATCH_QC_C_EXTU 0x1002
#define MASK_QC_C_EXTU 0xf003
#define MATCH_QC_CLO 0x0800300b
#define MASK_QC_CLO 0xfff0707f
#define MATCH_QC_COMPRESS2 0x0000300b
#define MASK_QC_COMPRESS2 0xfff0707f
#define MATCH_QC_COMPRESS3 0x0200300b
#define MASK_QC_COMPRESS3 0xfff0707f
#define MATCH_QC_CTO 0x0a00300b
#define MASK_QC_CTO 0xfff0707f
#define MATCH_QC_EXPAND2 0x0400300b
#define MASK_QC_EXPAND2 0xfff0707f
#define MATCH_QC_EXPAND3 0x0600300b
#define MASK_QC_EXPAND3 0xfff0707f
#define MATCH_QC_EXT 0x4000200b
#define MASK_QC_EXT 0xc000707f
#define MATCH_QC_EXTD 0xc000200b
#define MASK_QC_EXTD 0xc000707f
#define MATCH_QC_EXTDPR 0x1000300b
#define MASK_QC_EXTDPR 0xfe00707f
#define MATCH_QC_EXTDPRH 0x1200300b
#define MASK_QC_EXTDPRH 0xfe00707f
#define MATCH_QC_EXTDR 0x0a00300b
#define MASK_QC_EXTDR 0xfe00707f
#define MATCH_QC_EXTDU 0x8000200b
#define MASK_QC_EXTDU 0xc000707f
#define MATCH_QC_EXTDUPR 0x0c00300b
#define MASK_QC_EXTDUPR 0xfe00707f
#define MATCH_QC_EXTDUPRH 0x0e00300b
#define MASK_QC_EXTDUPRH 0xfe00707f
#define MATCH_QC_EXTDUR 0x0800300b
#define MASK_QC_EXTDUR 0xfe00707f
#define MATCH_QC_EXTU 0x0000200b
#define MASK_QC_EXTU 0xc000707f
#define MATCH_QC_INSB 0x4000100b
#define MASK_QC_INSB 0xc000707f
#define MATCH_QC_INSBH 0x8000100b
#define MASK_QC_INSBH 0xc000707f
#define MATCH_QC_INSBHR 0x0200300b
#define MASK_QC_INSBHR 0xfe00707f
#define MATCH_QC_INSBI 0x0000100b
#define MASK_QC_INSBI 0xc000707f
#define MATCH_QC_INSBPR 0x0400300b
#define MASK_QC_INSBPR 0xfe00707f
#define MATCH_QC_INSBPRH 0x0600300b
#define MASK_QC_INSBPRH 0xfe00707f
#define MATCH_QC_INSBR 0x0000300b
#define MASK_QC_INSBR 0xfe00707f
#define MATCH_QC_INSBRI 0x8000000b
#define MASK_QC_INSBRI 0x8000707f
/* xqcicli */
#define MATCH_QC_LIEQ 0x0200005b
#define MASK_QC_LIEQ 0x0600707f
#define MATCH_QC_LIEQI 0x0600005b
#define MASK_QC_LIEQI 0x0600707f
#define MATCH_QC_LIGE 0x0200505b
#define MASK_QC_LIGE 0x0600707f
#define MATCH_QC_LIGEI 0x0600505b
#define MASK_QC_LIGEI 0x0600707f
#define MATCH_QC_LIGEU 0x0200705b
#define MASK_QC_LIGEU 0x0600707f
#define MATCH_QC_LIGEUI 0x0600705b
#define MASK_QC_LIGEUI 0x0600707f
#define MATCH_QC_LILT 0x0200405b
#define MASK_QC_LILT 0x0600707f
#define MATCH_QC_LILTI 0x0600405b
#define MASK_QC_LILTI 0x0600707f
#define MATCH_QC_LILTU 0x0200605b
#define MASK_QC_LILTU 0x0600707f
#define MATCH_QC_LILTUI 0x0600605b
#define MASK_QC_LILTUI 0x0600707f
#define MATCH_QC_LINE 0x0200105b
#define MASK_QC_LINE 0x0600707f
#define MATCH_QC_LINEI 0x0600105b
#define MASK_QC_LINEI 0x0600707f
/* xqcicm */
#define MATCH_QC_MVEQ 0x0000005b
#define MASK_QC_MVEQ 0x0600707f
#define MATCH_QC_MVEQI 0x0400005b
#define MASK_QC_MVEQI 0x0600707f
#define MATCH_QC_MVGE 0x0000505b
#define MASK_QC_MVGE 0x0600707f
#define MATCH_QC_MVGEI 0x0400505b
#define MASK_QC_MVGEI 0x0600707f
#define MATCH_QC_MVGEU 0x0000705b
#define MASK_QC_MVGEU 0x0600707f
#define MATCH_QC_MVGEUI 0x0400705b
#define MASK_QC_MVGEUI 0x0600707f
#define MATCH_QC_MVLT 0x0000405b
#define MASK_QC_MVLT 0x0600707f
#define MATCH_QC_MVLTI 0x0400405b
#define MASK_QC_MVLTI 0x0600707f
#define MATCH_QC_MVLTU 0x0000605b
#define MASK_QC_MVLTU 0x0600707f
#define MATCH_QC_MVLTUI 0x0400605b
#define MASK_QC_MVLTUI 0x0600707f
#define MATCH_QC_MVNE 0x0000105b
#define MASK_QC_MVNE 0x0600707f
#define MATCH_QC_MVNEI 0x0400105b
#define MASK_QC_MVNEI 0x0600707f
/* xqcics */
#define MATCH_QC_SELECTEQI 0x0400205b
#define MASK_QC_SELECTEQI 0x0600707f
#define MATCH_QC_SELECTIEQ 0x0200205b
#define MASK_QC_SELECTIEQ 0x0600707f
#define MATCH_QC_SELECTIEQI 0x0600205b
#define MASK_QC_SELECTIEQI 0x0600707f
#define MATCH_QC_SELECTIIEQ 0x0000205b
#define MASK_QC_SELECTIIEQ 0x0600707f
#define MATCH_QC_SELECTIINE 0x0000305b
#define MASK_QC_SELECTIINE 0x0600707f
#define MATCH_QC_SELECTINE 0x0200305b
#define MASK_QC_SELECTINE 0x0600707f
#define MATCH_QC_SELECTINEI 0x0600305b
#define MASK_QC_SELECTINEI 0x0600707f
#define MATCH_QC_SELECTNEI 0x0400305b
#define MASK_QC_SELECTNEI 0x0600707f
/* xqcicsr */
#define MATCH_QC_CSRRWR 0x8c000073
#define MASK_QC_CSRRWR 0xfe00707f
#define MATCH_QC_CSRRWRI 0x8e000073
#define MASK_QC_CSRRWRI 0xfe00707f
/* xqciint */
#define MATCH_QC_C_CLRINT 0x100e
#define MASK_QC_C_CLRINT 0xf07f
#define MATCH_QC_C_DI 0x1b12
#define MASK_QC_C_DI 0xffff
#define MATCH_QC_C_DIR 0x1002
#define MASK_QC_C_DIR 0xf07f
#define MATCH_QC_C_EI 0x1b92
#define MASK_QC_C_EI 0xffff
#define MATCH_QC_C_EIR 0x1006
#define MASK_QC_C_EIR 0xf07f
#define MATCH_QC_C_MIENTER_NEST 0x1892
#define MASK_QC_C_MIENTER_NEST 0xffff
#define MATCH_QC_C_MIENTER 0x1812
#define MASK_QC_C_MIENTER 0xffff
#define MATCH_QC_C_MILEAVERET 0x1a12
#define MASK_QC_C_MILEAVERET 0xffff
#define MATCH_QC_C_MNRET 0x1992
#define MASK_QC_C_MNRET 0xffff
#define MATCH_QC_C_MRET 0x1912
#define MASK_QC_C_MRET 0xffff
#define MATCH_QC_C_SETINT 0x100a
#define MASK_QC_C_SETINT 0xf07f
#define MATCH_QC_CLRINTI 0xce000073
#define MASK_QC_CLRINTI 0xfe007fff
#define MATCH_QC_SETINTI 0xcc000073
#define MASK_QC_SETINTI 0xfe007fff
/* xqcilb */
#define MATCH_QC_E_J 0x00000000401f
#define MASK_QC_E_J 0x000001f1f07f
#define MATCH_QC_E_JAL 0x00000000c01f
#define MASK_QC_E_JAL 0x000001f1f07f
/* xqcili */
#define MATCH_QC_E_LI 0x00000000001f
#define MASK_QC_E_LI 0x00000000f07f
#define MATCH_QC_LI 0x0000001b
#define MASK_QC_LI 0x0000007f
/* xqcilia */
#define MATCH_QC_E_ADDAI 0x00000000201f
#define MASK_QC_E_ADDAI 0x00000000f07f
#define MATCH_QC_E_ADDI 0x00008000301f
#define MASK_QC_E_ADDI 0x0000c000707f
#define MATCH_QC_E_ANDAI 0x00000000a01f
#define MASK_QC_E_ANDAI 0x00000000f07f
#define MATCH_QC_E_ANDI 0x0000c000301f
#define MASK_QC_E_ANDI 0x0000c000707f
#define MATCH_QC_E_ORAI 0x00000000901f
#define MASK_QC_E_ORAI 0x00000000f07f
#define MATCH_QC_E_ORI 0x00004000301f
#define MASK_QC_E_ORI 0x0000c000707f
#define MATCH_QC_E_XORAI 0x00000000101f
#define MASK_QC_E_XORAI 0x00000000f07f
#define MATCH_QC_E_XORI 0x00000000301f
#define MASK_QC_E_XORI 0x0000c000707f
/* xqcilo */
#define MATCH_QC_E_LB 0x00000000501f
#define MASK_QC_E_LB 0x0000c000707f
#define MATCH_QC_E_LBU 0x00004000501f
#define MASK_QC_E_LBU 0x0000c000707f
#define MATCH_QC_E_LH 0x00008000501f
#define MASK_QC_E_LH 0x0000c000707f
#define MATCH_QC_E_LHU 0x0000c000501f
#define MASK_QC_E_LHU 0x0000c000707f
#define MATCH_QC_E_LW 0x00000000601f
#define MASK_QC_E_LW 0x0000c000707f
#define MATCH_QC_E_SB 0x00004000601f
#define MASK_QC_E_SB 0x0000c000707f
#define MATCH_QC_E_SH 0x00008000601f
#define MASK_QC_E_SH 0x0000c000707f
#define MATCH_QC_E_SW 0x0000c000601f
#define MASK_QC_E_SW 0x0000c000707f
/* xqcilsm */
#define MATCH_QC_LWM 0x0000700b
#define MASK_QC_LWM 0xc000707f
#define MATCH_QC_LWMI 0x4000700b
#define MASK_QC_LWMI 0xc000707f
#define MATCH_QC_SETWM 0x8000702b
#define MASK_QC_SETWM 0xc000707f
#define MATCH_QC_SETWMI 0xc000702b
#define MASK_QC_SETWMI 0xc000707f
#define MATCH_QC_SWM 0x0000702b
#define MASK_QC_SWM 0xc000707f
#define MATCH_QC_SWMI 0x4000702b
#define MASK_QC_SWMI 0xc000707f
/* xqciio */
#define MATCH_QC_INW 0x0000500b
#define MASK_QC_INW 0x0000707f
#define MATCH_QC_OUTW 0x0000400b
#define MASK_QC_OUTW 0x0000707f
/* xqcisim */
#define MATCH_QC_C_PTRACE 0x0002
#define MASK_QC_C_PTRACE 0xffff
#define MATCH_QC_PCOREDUMP 0x60002013
#define MASK_QC_PCOREDUMP 0xffffffff
#define MATCH_QC_PEXIT 0xb0002013
#define MASK_QC_PEXIT 0xfff07fff
#define MATCH_QC_PPREG 0x80002013
#define MASK_QC_PPREG 0xfff07fff
#define MATCH_QC_PPREGS 0x70002013
#define MASK_QC_PPREGS 0xffffffff
#define MATCH_QC_PPUTC 0x90002013
#define MASK_QC_PPUTC 0xfff07fff
#define MATCH_QC_PPUTCI 0x40002013
#define MASK_QC_PPUTCI 0xf00fffff
#define MATCH_QC_PPUTS 0xa0002013
#define MASK_QC_PPUTS 0xfff07fff
#define MATCH_QC_PSYSCALL 0xc0002013
#define MASK_QC_PSYSCALL 0xfff07fff
#define MATCH_QC_PSYSCALLI 0x00002013
#define MASK_QC_PSYSCALLI 0xc00fffff
/* xqcisls */
#define MATCH_QC_LRB 0x8000700b
#define MASK_QC_LRB 0xf000707f
#define MATCH_QC_LRBU 0xb000700b
#define MASK_QC_LRBU 0xf000707f
#define MATCH_QC_LRH 0x9000700b
#define MASK_QC_LRH 0xf000707f
#define MATCH_QC_LRHU 0xc000700b
#define MASK_QC_LRHU 0xf000707f
#define MATCH_QC_LRW 0xa000700b
#define MASK_QC_LRW 0xf000707f
#define MATCH_QC_SRB 0xd000602b
#define MASK_QC_SRB 0xf000707f
#define MATCH_QC_SRH 0xe000602b
#define MASK_QC_SRH 0xf000707f
#define MATCH_QC_SRW 0xf000602b
#define MASK_QC_SRW 0xf000707f
/* xqcisync */
#define MATCH_QC_C_DELAY 0x0002
#define MASK_QC_C_DELAY 0xff83
#define MATCH_QC_C_SYNC 0x8001
#define MASK_QC_C_SYNC 0xfc7f
#define MATCH_QC_C_SYNCR 0x8401
#define MASK_QC_C_SYNCR 0xfc7f
#define MATCH_QC_C_SYNCWF 0x9001
#define MASK_QC_C_SYNCWF 0xfc7f
#define MATCH_QC_C_SYNCWL 0x9401
#define MASK_QC_C_SYNCWL 0xfc7f
#define MATCH_QC_SYNC 0x10003013
#define MASK_QC_SYNC 0xfe0fffff
#define MATCH_QC_SYNCR 0x20003013
#define MASK_QC_SYNCR 0xfe0fffff
#define MATCH_QC_SYNCWF 0x40003013
#define MASK_QC_SYNCWF 0xfe0fffff
#define MATCH_QC_SYNCWL 0x80003013
#define MASK_QC_SYNCWL 0xfe0fffff
