...
/* xqcia */
{"qc.addsat", 32, INSN_CLASS_XQCIA, "d,s,t", MATCH_QC_ADDSAT, MASK_QC_ADDSAT, match_opcode, 0},
{"qc.addusat", 32, INSN_CLASS_XQCIA, "d,s,t", MATCH_QC_ADDUSAT, MASK_QC_ADDUSAT, match_opcode, 0},
{"qc.norm", 32, INSN_CLASS_XQCIA, "d,s", MATCH_QC_NORM, MASK_QC_NORM, match_opcode, 0},
{"qc.normeu", 32, INSN_CLASS_XQCIA, "d,s", MATCH_QC_NORMEU, MASK_QC_NORMEU, match_opcode, 0},
{"qc.normu", 32, INSN_CLASS_XQCIA, "d,s", MATCH_QC_NORMU, MASK_QC_NORMU, match_opcode, 0},
{"qc.shlsat", 32, INSN_CLASS_XQCIA, "d,s,t", MATCH_QC_SHLSAT, MASK_QC_SHLSAT, match_opcode, 0},
{"qc.shlusat", 32, INSN_CLASS_XQCIA, "d,s,t", MATCH_QC_SHLUSAT, MASK_QC_SHLUSAT, match_opcode, 0},
{"qc.subsat", 32, INSN_CLASS_XQCIA, "d,s,t", MATCH_QC_SUBSAT, MASK_QC_SUBSAT, match_opcode, 0},
{"qc.subusat", 32, INSN_CLASS_XQCIA, "d,s,t", MATCH_QC_SUBUSAT, MASK_QC_SUBUSAT, match_opcode, 0},
{"qc.wrap", 32, INSN_CLASS_XQCIA, "d,s,t", MATCH_QC_WRAP, MASK_QC_WRAP, match_opcode, 0},
{"qc.wrapi", 32, INSN_CLASS_XQCIA, "d,s,Xqh", MATCH_QC_WRAPI, MASK_QC_WRAPI, match_opcode, 0},//出错
/* xqciac */
{"qc.c.muliadd", 32, INSN_CLASS_XQCIAC, "Ct,Cs,Wcl", MATCH_QC_C_MULIADD, MASK_QC_C_MULIADD, match_opcode, 0},
{"qc.c.mveqz", 32, INSN_CLASS_XQCIAC, "Ct,Cs", MATCH_QC_C_MVEQZ, MASK_QC_C_MVEQZ, match_opcode, 0},
// {"qc.muliadd", 32, INSN_CLASS_XQCIAC, "d,s,Xqd", MATCH_QC_MULIADD, MASK_QC_MULIADD, match_opcode, 0},//Xqd,Xqa有问题
// {"qc.shladd", 32, INSN_CLASS_XQCIAC, "d,s,t,{Xqa}", MATCH_QC_SHLADD, MASK_QC_SHLADD, match_opcode, 0},
// /* xqcibi */
// {"qc.beqi", 32, INSN_CLASS_XQCIBI, "s,Xqb,Xqf", MATCH_QC_BEQI, MASK_QC_BEQI, match_opcode, 0},
// {"qc.begi", 32, INSN_CLASS_XQCIBI, "s,Xqb,Xqf", MATCH_QC_BGEI, MASK_QC_BGEI, match_opcode, 0},
// {"qc.bgeui", 32, INSN_CLASS_XQCIBI, "s,Xqb,Xqf", MATCH_QC_BGEUI, MASK_QC_BGEUI, match_opcode, 0},
// {"qc.blti", 32, INSN_CLASS_XQCIBI, "s,Xqb,Xqf", MATCH_QC_BLTI, MASK_QC_BLTI, match_opcode, 0},
// {"qc.bltui", 32, INSN_CLASS_XQCIBI, "s,Xqb,Xqf", MATCH_QC_BLTUI, MASK_QC_BLTUI, match_opcode, 0},
// {"qc.bnei", 32, INSN_CLASS_XQCIBI, "s,Xqb,Xqf", MATCH_QC_BNEI, MASK_QC_BNEI, match_opcode, 0},
// {"qc.e.beqi", 32, INSN_CLASS_XQCIBI, "s,Xqg,Xqf", MATCH_QC_E_BEQI, MASK_QC_E_BEQI, match_opcode, 0},
// {"qc.e.bgei", 32, INSN_CLASS_XQCIBI, "s,Xqg,Xqf", MATCH_QC_E_BGEI, MASK_QC_E_BGEI, match_opcode, 0},
// {"qc.e.bgeui", 32, INSN_CLASS_XQCIBI, "s,Xqg,Xqf", MATCH_QC_E_BGEUI, MASK_QC_E_BGEUI, match_opcode, 0},
// {"qc.e.blti", 32, INSN_CLASS_XQCIBI, "s,Xqg,Xqf", MATCH_QC_E_BLTI, MASK_QC_E_BLTI, match_opcode, 0},
// {"qc.e.bltui", 32, INSN_CLASS_XQCIBI, "s,Xqg,Xqf", MATCH_QC_E_BLTUI, MASK_QC_E_BLTUI, match_opcode, 0},
// {"qc.e.bnei", 32, INSN_CLASS_XQCIBI, "s,Xqg,Xqf", MATCH_QC_E_BNEI, MASK_QC_E_BNEI, match_opcode, 0},
// /* xqcibm */
// {"qc.brev32", 32, INSN_CLASS_XQCIBM, "d,s", MATCH_QC_BREV32, MASK_QC_BREV32, match_opcode, 0},
// {"qc.c.bexti", 32, INSN_CLASS_XQCIBM, "Cs,CV", MATCH_QC_C_BEXTI, MASK_QC_C_BEXTI, match_opcode, 0},
// {"qc.c.bseti", 32, INSN_CLASS_XQCIBM, "Cs,CV", MATCH_QC_C_BSETI, MASK_QC_C_BSETI, match_opcode, 0},
// // {"qc.c.extu", 32, INSN_CLASS_XQCIBM, "Wc3,CV", MATCH_QC_C_EXTU, MASK_QC_C_EXTU, match_opcode, 0},
// {"qc.clo", 32, INSN_CLASS_XQCIBM, "d,s", MATCH_QC_CLO, MASK_QC_CLO, match_opcode, 0},
// {"qc.compress2", 32, INSN_CLASS_XQCIBM, "d,s", MATCH_QC_COMPRESS2, MASK_QC_COMPRESS2, match_opcode, 0},
// {"qc.compress3", 32, INSN_CLASS_XQCIBM, "d,s", MATCH_QC_COMPRESS3, MASK_QC_COMPRESS3, match_opcode, 0},
// {"qc.cto", 32, INSN_CLASS_XQCIBM, "d,s", MATCH_QC_CTO, MASK_QC_CTO, match_opcode, 0},
// {"qc.expand2", 32, INSN_CLASS_XQCIBM, "d,s", MATCH_QC_EXPAND2, MASK_QC_EXPAND2, match_opcode, 0},
// {"qc.expand3", 32, INSN_CLASS_XQCIBM, "d,s", MATCH_QC_EXPAND3, MASK_QC_EXPAND3, match_opcode, 0},
// {"qc.ext", 32, INSN_CLASS_XQCIBM, "d,s,Xqa,Xqb", MATCH_QC_EXT, MASK_QC_EXT, match_opcode, 0},
// {"qc.extd", 32, INSN_CLASS_XQCIBM, "d,s,Xqa,Xqb", MATCH_QC_EXTD, MASK_QC_EXTD, match_opcode, 0},
// {"qc.extdpr", 32, INSN_CLASS_XQCIBM, "d,s,t", MATCH_QC_EXTDPR, MASK_QC_EXTDPR, match_opcode, 0},
// {"qc.extdprh", 32, INSN_CLASS_XQCIBM, "d,s,t", MATCH_QC_EXTDPRH, MASK_QC_EXTDPRH, match_opcode, 0},
// {"qc.extdr", 32, INSN_CLASS_XQCIBM, "d,s,t", MATCH_QC_EXTDR, MASK_QC_EXTDR, match_opcode, 0},
// {"qc.extdu", 32, INSN_CLASS_XQCIBM, "d,s,Xqa,Xqb", MATCH_QC_EXTDU, MASK_QC_EXTDU, match_opcode, 0},
// {"qc.extdupr", 32, INSN_CLASS_XQCIBM, "d,s,t", MATCH_QC_EXTDUPR, MASK_QC_EXTDUPR, match_opcode, 0},
// {"qc.extduprh", 32, INSN_CLASS_XQCIBM, "d,s,t", MATCH_QC_EXTDUPRH, MASK_QC_EXTDUPRH, match_opcode, 0},
// {"qc.extdur", 32, INSN_CLASS_XQCIBM, "d,s,t", MATCH_QC_EXTDUR, MASK_QC_EXTDUR, match_opcode, 0},
// {"qc.extu", 32, INSN_CLASS_XQCIBM, "d,s,Xqa,Xqb", MATCH_QC_EXTU, MASK_QC_EXTU, match_opcode, 0},
// {"qc.insb", 32, INSN_CLASS_XQCIBM, "d,s,Xqa,Xqb", MATCH_QC_INSB, MASK_QC_INSB, match_opcode, 0},
// {"qc.insbh", 32, INSN_CLASS_XQCIBM, "d,s,Xqa,Xqb", MATCH_QC_INSBH, MASK_QC_INSBH, match_opcode, 0},
// {"qc.insbr", 32, INSN_CLASS_XQCIBM, "d,s,t", MATCH_QC_INSBR, MASK_QC_INSBR, match_opcode, 0},
// {"qc.insbi", 32, INSN_CLASS_XQCIBM, "d,Xqc,Xqa,Xqb", MATCH_QC_INSB, MASK_QC_INSB, match_opcode, 0},
// {"qc.insbpr", 32, INSN_CLASS_XQCIBM, "d,s,t", MATCH_QC_INSBPR, MASK_QC_INSBPR, match_opcode, 0},
// {"qc.insbprh", 32, INSN_CLASS_XQCIBM, "d,s,t", MATCH_QC_INSBPRH, MASK_QC_INSBPRH, match_opcode, 0},
// {"qc.insbr", 32, INSN_CLASS_XQCIBM, "d,s,t", MATCH_QC_INSBR, MASK_QC_INSBR, match_opcode, 0},
// // {"qc.insbri", 32, INSN_CLASS_XQCIBM, "d,s,Xqh", MATCH_QC_INSBRI, MASK_QC_INSBRI, match_opcode, 0},
// /* xqcicli */
// {"qc.lieq", 32, INSN_CLASS_XQCICLI, "d,s,t,Xqp", MATCH_QC_LIEQ, MASK_QC_LIEQ, match_opcode, 0},
// {"qc.lieqi", 32, INSN_CLASS_XQCICLI, "d,s,Xqb,Xqp", MATCH_QC_LIEQI, MASK_QC_LIEQI, match_opcode, 0},
// {"qc.lige", 32, INSN_CLASS_XQCICLI, "d,s,t,Xqp", MATCH_QC_LIGE, MASK_QC_LIGE, match_opcode, 0},
// {"qc.ligei", 32, INSN_CLASS_XQCICLI, "d,s,Xqb,Xqp", MATCH_QC_LIGEI, MASK_QC_LIGEI, match_opcode, 0},
// {"qc.ligeu", 32, INSN_CLASS_XQCICLI, "d,s,t,Xqp", MATCH_QC_LIGEU, MASK_QC_LIGEU, match_opcode, 0},
// {"qc.ligeui", 32, INSN_CLASS_XQCICLI, "d,s,Xqb,Xqp", MATCH_QC_LIGEUI, MASK_QC_LIGEUI, match_opcode, 0},
// {"qc.lilt", 32, INSN_CLASS_XQCICLI, "d,s,t,Xqp", MATCH_QC_LILT, MASK_QC_LILT, match_opcode, 0},
// {"qc.lilti", 32, INSN_CLASS_XQCICLI, "d,s,Xqb,Xqp", MATCH_QC_LILTI, MASK_QC_LILTI, match_opcode, 0},
// {"qc.liltu", 32, INSN_CLASS_XQCICLI, "d,s,t,Xqp", MATCH_QC_LILTU, MASK_QC_LILTU, match_opcode, 0},
// {"qc.liltui", 32, INSN_CLASS_XQCICLI, "d,s,Xqb,Xqp", MATCH_QC_LILTUI, MASK_QC_LILTUI, match_opcode, 0},
// {"qc.line", 32, INSN_CLASS_XQCICLI, "d,s,t,Xqp", MATCH_QC_LINE, MASK_QC_LINE, match_opcode, 0},
// {"qc.linei", 32, INSN_CLASS_XQCICLI, "d,s,Xqb,Xqp", MATCH_QC_LINEI, MASK_QC_LINEI, match_opcode, 0},
// /* xqcicm */
// {"qc.mveq", 32, INSN_CLASS_XQCICM, "d,s,t,r", MATCH_QC_MVEQ, MASK_QC_MVEQ, match_opcode, 0},
// {"qc.mveqi", 32, INSN_CLASS_XQCICM, "d,s,Xqb,r", MATCH_QC_MVEQI, MASK_QC_MVEQI, match_opcode, 0},
// {"qc.mvge", 32, INSN_CLASS_XQCICM, "d,s,t,r", MATCH_QC_MVGE, MASK_QC_MVGE, match_opcode, 0},
// {"qc.mvgei", 32, INSN_CLASS_XQCICM, "d,s,Xqb,r", MATCH_QC_MVGEI, MASK_QC_MVGEI, match_opcode, 0},
// {"qc.mvgeu", 32, INSN_CLASS_XQCICM, "d,s,t,r", MATCH_QC_MVGEU, MASK_QC_MVGEU, match_opcode, 0},
// {"qc.mvgeui", 32, INSN_CLASS_XQCICM, "d,s,Xqb,r", MATCH_QC_MVGEUI, MASK_QC_MVGEUI, match_opcode, 0},
// {"qc.mvlt", 32, INSN_CLASS_XQCICM, "d,s,t,r", MATCH_QC_MVLT, MASK_QC_MVLT, match_opcode, 0},
// {"qc.mvlti", 32, INSN_CLASS_XQCICM, "d,s,Xqb,r", MATCH_QC_MVLTI, MASK_QC_MVLTI, match_opcode, 0},
// {"qc.mvltu", 32, INSN_CLASS_XQCICM, "d,s,t,r", MATCH_QC_MVLTU, MASK_QC_MVLTU, match_opcode, 0},
// {"qc.mvltui", 32, INSN_CLASS_XQCICM, "d,s,Xqb,r", MATCH_QC_MVLTUI, MASK_QC_MVLTUI, match_opcode, 0},
// {"qc.mvne", 32, INSN_CLASS_XQCICM, "d,s,t,r", MATCH_QC_MVNE, MASK_QC_MVNE, match_opcode, 0},
// {"qc.mvnei", 32, INSN_CLASS_XQCICM, "d,s,Xqb,r", MATCH_QC_MVNEI, MASK_QC_MVNEI, match_opcode, 0},
// /* xqcics */
// {"qc.selecteqi", 32, INSN_CLASS_XQCICM, "d,Xqq,t,r", MATCH_QC_SELECTEQI, MASK_QC_SELECTEQI, match_opcode, 0},
// {"qc.selectieq", 32, INSN_CLASS_XQCICM, "d,s,t,Xqp", MATCH_QC_SELECTIEQ, MASK_QC_SELECTIEQ, match_opcode, 0},
// {"qc.selectieqi", 32, INSN_CLASS_XQCICM, "d,Xqq,t,Xqp", MATCH_QC_SELECTIEQI, MASK_QC_SELECTIEQI, match_opcode, 0},
// {"qc.selectiieq", 32, INSN_CLASS_XQCICM, "d,s,Xqb,Xqp", MATCH_QC_SELECTIIEQ, MASK_QC_SELECTIIEQ, match_opcode, 0},
// {"qc.selectiine", 32, INSN_CLASS_XQCICM, "d,s,Xqb,Xqp", MATCH_QC_SELECTIINE, MASK_QC_SELECTIINE, match_opcode, 0},
// {"qc.selectine", 32, INSN_CLASS_XQCICM, "d,s,t,Xqp", MATCH_QC_SELECTINE, MASK_QC_SELECTINE, match_opcode, 0},
// {"qc.selectinei", 32, INSN_CLASS_XQCICM, "d,Xqc,t,Xqp", MATCH_QC_SELECTINEI, MASK_QC_SELECTINEI, match_opcode, 0},
// {"qc.selectnei", 32, INSN_CLASS_XQCICM, "d,Xqc,t,r", MATCH_QC_SELECTNEI, MASK_QC_SELECTNEI, match_opcode, 0},
// /* xqcicsr */
// {"qc.csrrwr", 32, INSN_CLASS_XQCICSR, "d,s,t", MATCH_QC_CSRRWR, MASK_QC_CSRRWR, match_opcode, 0},
// {"qc.csrrwri", 32, INSN_CLASS_XQCICSR, "d,Xqc,t", MATCH_QC_CSRRWRI, MASK_QC_CSRRWRI, match_opcode, 0},
// /* xqciint */
// // {"qc.c.clrint", 32, INSN_CLASS_XQCIINT, "Wc3", MATCH_QC_C_CLRINT, MASK_QC_C_CLRINT, match_opcode, 0},
// {"qc.c.di", 32, INSN_CLASS_XQCIINT, "", MATCH_QC_C_DI, MASK_QC_C_DI, match_opcode, 0},
// // {"qc.c.dir", 32, INSN_CLASS_XQCIINT, "Wc3", MATCH_QC_C_DIR, MASK_QC_C_DIR, match_opcode, 0},
// {"qc.c.ei", 32, INSN_CLASS_XQCIINT, "", MATCH_QC_C_EI, MASK_QC_C_EI, match_opcode, 0},
// // {"qc.c.eir", 32, INSN_CLASS_XQCIINT, "Wc3", MATCH_QC_C_EIR, MASK_QC_C_EIR, match_opcode, 0},
// {"qc.c.mienter.nest", 32, INSN_CLASS_XQCIINT, "", MATCH_QC_C_MIENTER_NEST, MASK_QC_C_MIENTER_NEST, match_opcode, 0},
// {"qc.c.mienter", 32, INSN_CLASS_XQCIINT, "", MATCH_QC_C_MIENTER, MASK_QC_C_MIENTER, match_opcode, 0},
// {"qc.c.mileaveret", 32, INSN_CLASS_XQCIINT, "", MATCH_QC_C_MILEAVERET, MASK_QC_C_MILEAVERET, match_opcode, 0},
// {"qc.c.mnret", 32, INSN_CLASS_XQCIINT, "", MATCH_QC_C_MNRET, MASK_QC_C_MNRET, match_opcode, 0},
// {"qc.c.mret", 32, INSN_CLASS_XQCIINT, "", MATCH_QC_C_MRET, MASK_QC_C_MRET, match_opcode, 0},
// {"qc.c.setint", 32, INSN_CLASS_XQCIINT, "Wc3", MATCH_QC_C_SETINT, MASK_QC_C_SETINT, match_opcode, 0},
// {"qc.clrinti", 32, INSN_CLASS_XQCIINT, "Xqi", MATCH_QC_CLRINTI, MASK_QC_CLRINTI, match_opcode, 0},
// {"qc.setinti", 32, INSN_CLASS_XQCIINT, "Xqi", MATCH_QC_SETINTI, MASK_QC_SETINTI, match_opcode, 0},
// /* xqcilb */
// {"qc.e.j", 32, INSN_CLASS_XQCILB, "Xqj", MATCH_QC_E_J, MASK_QC_E_J, match_opcode, 0},
// {"qc.e.jal", 32, INSN_CLASS_XQCILB, "Xqj", MATCH_QC_E_JAL, MASK_QC_E_JAL, match_opcode, 0},
// /* xqcili */
// {"qc.e.li", 32, INSN_CLASS_XQCILI, "d,Xqk", MATCH_QC_E_LI, MASK_QC_E_LI, match_opcode, 0},
// {"qc.li", 32, INSN_CLASS_XQCILI, "d,Xqk", MATCH_QC_LI, MASK_QC_LI, match_opcode, 0},
// /* xqcilia */
// {"qc.e.addai", 32, INSN_CLASS_XQCILIA, "d,Xqk", MATCH_QC_E_ADDAI, MASK_QC_E_ADDAI, match_opcode, 0},
// {"qc.e.addi", 32, INSN_CLASS_XQCILIA, "d,s,Xql", MATCH_QC_E_ADDI, MASK_QC_E_ADDI, match_opcode, 0},
// {"qc.e.andai", 32, INSN_CLASS_XQCILIA, "d,Xqk", MATCH_QC_E_ANDAI, MASK_QC_E_ANDAI, match_opcode, 0},
// {"qc.e.andi", 32, INSN_CLASS_XQCILIA, "d,s,Xql", MATCH_QC_E_ANDI, MASK_QC_E_ANDI, match_opcode, 0},
// {"qc.e.orai", 32, INSN_CLASS_XQCILIA, "d,Xqk", MATCH_QC_E_ORAI, MASK_QC_E_ORAI, match_opcode, 0},
// {"qc.e.ori", 32, INSN_CLASS_XQCILIA, "d,s,Xql", MATCH_QC_E_ORI, MASK_QC_E_ORI, match_opcode, 0},
// {"qc.e.xorai", 32, INSN_CLASS_XQCILIA, "d,Xqk", MATCH_QC_E_XORAI, MASK_QC_E_XORAI, match_opcode, 0},
// {"qc.e.xori", 32, INSN_CLASS_XQCILIA, "d,s,Xql", MATCH_QC_E_XORI, MASK_QC_E_XORI, match_opcode, 0},
// /* xqcilo */
// {"qc.e.lb", 32, INSN_CLASS_XQCILO, "d,Xql(s)", MATCH_QC_E_LB, MASK_QC_E_LB, match_opcode, 0},
// {"qc.e.lbu", 32, INSN_CLASS_XQCILO, "d,Xql(s)", MATCH_QC_E_LBU, MASK_QC_E_LBU, match_opcode, 0},
// {"qc.e.lh", 32, INSN_CLASS_XQCILO, "d,Xql(s)", MATCH_QC_E_LH, MASK_QC_E_LH, match_opcode, 0},
// {"qc.e.lhu", 32, INSN_CLASS_XQCILO, "d,Xql(s)", MATCH_QC_E_LHU, MASK_QC_E_LHU, match_opcode, 0},
// {"qc.e.lw", 32, INSN_CLASS_XQCILO, "d,Xql(s)", MATCH_QC_E_LW, MASK_QC_E_LW, match_opcode, 0},
// {"qc.e.sb", 32, INSN_CLASS_XQCILO, "t,Xql(s)", MATCH_QC_E_SB, MASK_QC_E_SB, match_opcode, 0},
// {"qc.e.sh", 32, INSN_CLASS_XQCILO, "t,Xql(s)", MATCH_QC_E_SH, MASK_QC_E_SH, match_opcode, 0},
// {"qc.e.sw", 32, INSN_CLASS_XQCILO, "t,Xql(s)", MATCH_QC_E_SW, MASK_QC_E_SW, match_opcode, 0},
// /* xqcilsm */
// {"qc.lwm", 32, INSN_CLASS_XQCILO, "d,t,Xqm(s)", MATCH_QC_LWM, MASK_QC_LWM, match_opcode, 0},
// {"qc.lwmi", 32, INSN_CLASS_XQCILO, "d,t,Xqm(s)", MATCH_QC_LWMI, MASK_QC_LWMI, match_opcode, 0},
// {"qc.setwm", 32, INSN_CLASS_XQCILO, "d,t,Xqm(s)", MATCH_QC_SETWM, MASK_QC_SETWM, match_opcode, 0},
// {"qc.setwmi", 32, INSN_CLASS_XQCILO, "d,t,Xqm(s)", MATCH_QC_SETWMI, MASK_QC_SETWMI, match_opcode, 0},
// {"qc.swm", 32, INSN_CLASS_XQCILO, "d,t,Xqm(s)", MATCH_QC_SWM, MASK_QC_SWM, match_opcode, 0},
// {"qc.swmi", 32, INSN_CLASS_XQCILO, "d,t,Xqm(s)", MATCH_QC_SWMI, MASK_QC_SWMI, match_opcode, 0},
/* xqcisim */
// {"qc.c.ptrace", 32, INSN_CLASS_XQCISIM, "", MATCH_QC_C_PTRACE, MASK_QC_C_PTRACE, match_opcode, 0},
// {"qc.pcoredump", 32, INSN_CLASS_XQCISIM, "", MATCH_QC_PCOREDUMP, MASK_QC_PCOREDUMP, match_opcode, 0},
// {"qc.pexit", 32, INSN_CLASS_XQCISIM, "s", MATCH_QC_PEXIT, MASK_QC_PEXIT, match_opcode, 0},
// {"qc.ppreg", 32, INSN_CLASS_XQCISIM, "s", MATCH_QC_PPREG, MASK_QC_PPREG, match_opcode, 0},
// {"qc.ppregs", 32, INSN_CLASS_XQCISIM, "", MATCH_QC_PPREGS, MASK_QC_PPREGS, match_opcode, 0},
// {"qc.pputc", 32, INSN_CLASS_XQCISIM, "s", MATCH_QC_PPUTC, MASK_QC_PPUTC, match_opcode, 0},
// // {"qc.pputci", 32, INSN_CLASS_XQCISIM, "Xqn", MATCH_QC_PPUTCI, MASK_QC_PPUTCI, match_opcode, 0},
// {"qc.pputs", 32, INSN_CLASS_XQCISIM, "s", MATCH_QC_PPUTS, MASK_QC_PPUTS, match_opcode, 0},
// {"qc.psyscall", 32, INSN_CLASS_XQCISIM, "s", MATCH_QC_PSYSCALL, MASK_QC_PSYSCALL, match_opcode, 0},
// {"qc.psyscalli", 32, INSN_CLASS_XQCISIM, "Xqo", MATCH_QC_PSYSCALLI, MASK_QC_PSYSCALLI, match_opcode, 0},
// /* xqcisls */
// {"qc.lrb", 32, INSN_CLASS_XQCISLS, "d,s,t,Xqb", MATCH_QC_LRB, MASK_QC_LRB, match_opcode, 0},
// {"qc.lrbu", 32, INSN_CLASS_XQCISLS, "d,s,t,Xqb", MATCH_QC_LRBU, MASK_QC_LRBU, match_opcode, 0},
// {"qc.lrh", 32, INSN_CLASS_XQCISLS, "d,s,t,Xqb", MATCH_QC_LRH, MASK_QC_LRH, match_opcode, 0},
// {"qc.lrhu", 32, INSN_CLASS_XQCISLS, "d,s,t,Xqb", MATCH_QC_LRHU, MASK_QC_LRHU, match_opcode, 0},
// {"qc.lrw", 32, INSN_CLASS_XQCISLS, "d,s,t,Xqb", MATCH_QC_LRW, MASK_QC_LRW, match_opcode, 0},
// {"qc.srb", 32, INSN_CLASS_XQCISLS, "d,s,t,Xqb", MATCH_QC_SRB, MASK_QC_SRB, match_opcode, 0},
// {"qc.srh", 32, INSN_CLASS_XQCISLS, "d,s,t,Xqb", MATCH_QC_SRH, MASK_QC_SRH, match_opcode, 0},
// {"qc.srw", 32, INSN_CLASS_XQCISLS, "d,s,t,Xqb", MATCH_QC_SRW, MASK_QC_SRW, match_opcode, 0},
/* xqcisync */
// {"qc.c.delay", 32, INSN_CLASS_XQCISYNC, "Wcm", MATCH_QC_C_DELAY, MASK_QC_C_DELAY, match_opcode, 0},
// {"qc.c.sync", 32, INSN_CLASS_XQCISYNC, "Wc1", MATCH_QC_C_SYNC, MASK_QC_C_SYNC, match_opcode, 0},
// {"qc.c.syncr", 32, INSN_CLASS_XQCISYNC, "Wc1", MATCH_QC_C_SYNCR, MASK_QC_C_SYNCR, match_opcode, 0},
// {"qc.c.syncwf", 32, INSN_CLASS_XQCISYNC, "Wc1", MATCH_QC_C_SYNCWF, MASK_QC_C_SYNCWF, match_opcode, 0},
// {"qc.c.syncwl", 32, INSN_CLASS_XQCISYNC, "Wc1", MATCH_QC_C_SYNCWL, MASK_QC_C_SYNCWL, match_opcode, 0},
// {"qc.sync", 32, INSN_CLASS_XQCISYNC, "t", MATCH_QC_SYNC, MASK_QC_SYNC, match_opcode, 0},
// {"qc.syncr", 32, INSN_CLASS_XQCISYNC, "t", MATCH_QC_SYNCR, MASK_QC_SYNCR, match_opcode, 0},
// {"qc.syncwf", 32, INSN_CLASS_XQCISYNC, "t", MATCH_QC_SYNCWF, MASK_QC_SYNCWF, match_opcode, 0},
// {"qc.syncwl", 32, INSN_CLASS_XQCISYNC, "t", MATCH_QC_SYNCWL, MASK_QC_SYNCWL, match_opcode, 0},
